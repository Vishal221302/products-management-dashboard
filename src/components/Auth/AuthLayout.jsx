      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full p-12 flex flex-col justify-between">
          ...
          <div className="relative z-20 w-full h-full p-8 flex flex-col justify-between text-white">
            ...
            <div className="mt-12">
              <div className="p-6 rounded-2xl bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg border border-white/20 shadow-lg">
                <div className="flex items-start space-x-5">
                  <div className="flex-shrink-0">
                    <div className="relative">
                      {/* Glass Avatar */}
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400/30 to-purple-500/30 backdrop-blur-sm border border-white/30 flex items-center justify-center">
                        <span className="text-white font-bold text-lg">SC</span>
                      </div>
                      {/* Verified Badge */}
                      <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border border-white/40 flex items-center justify-center shadow-md">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/90 italic text-base leading-relaxed">
                      "VisionPro revolutionized our product management lifecycle. The insights we gained led to a 40% improvement in feature delivery speed."
                    </p>
                    <div className="mt-4">
                      <p className="font-semibold text-white">Sarah Chen</p>
                      <p className="text-blue-100/70 text-sm">Chief Product Officer • TechGrowth Inc.</p>
                    </div>
                  </div>
                </div>
              </div>
